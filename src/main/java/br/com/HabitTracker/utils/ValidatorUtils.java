package br.com.HabitTracker.utils;
...
public class ValidatorUtils {
    ...
    public <T> void checkFieldNotNullAndNotEmptyOrThrowException(T target, String errorMessage, Class<? extends RuntimeException> customException) {
    ...
    public <T> void checkObjectIsNullOrThrowException(T target, String errorMessage, Class<? extends RuntimeException> customException) {
